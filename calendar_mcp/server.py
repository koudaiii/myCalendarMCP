...
class CalendarMCPServer:
    ...
    def __init__(self):
        ...
        if EVENTKIT_AVAILABLE:
            try:
                ...
                print("✅ EventKit フレームワークが初期化されました")
            except Exception as e:
                print(f"⚠️  EventKit 初期化エラー: {e}")
        else:
            print("❌ EventKit フレームワークが利用できません")
            
        self._setup_handlers()
        print("🔧 MCP ハンドラーが設定されました")
        ...
        async def call_tool(name: str, arguments: Dict[str, Any]) -> List[TextContent]:
            ...
            try:
                if name == "get_events":
                    ...
                    return [TextContent(
                        type="text",
                        text=f"Event created successfully: {result}"
                    )]
    ...
    async def _get_events(self, start_date: Optional[str] = None, 
    ...
    async def _create_event(self, title: str, start_date: str, end_date: str,
